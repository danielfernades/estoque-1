...
<body>
<div class="row">
	<div class="grid_12"><span class="example">
...
<div class="row">
<div class="grid_6"><span class="example"><a href="cadastro.php" class="btn">Cadastrar Novo Produto</a> </span></div>
<div class="grid_6"><span class="example"><a href="pagination/pagination.php" class="btn">Listar Produtos</a> </span></div>
</div>

<div class="row">
<div class="grid_6"><span class="example"><a href="editar.php" class="btn">Editar Cadastro de um produto</a> </span></div>
<div class="grid_6"><span class="example"><a href="editar.php" class="btn">Excluir Um  produto</a> </span></div>
</div>

<p align="center"><a href="./index.php" class="btn">Voltar Painel Principal</a></p>
